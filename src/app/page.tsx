...
import logoHappyCog from '@/images/logos/happycog.jpeg'
import logoPostlight from '@/images/logos/launchbynttdata.jpeg'
import logoHousingWorks from '@/images/logos/housingworks.jpeg'
      ...
      <Container className="mt-9">
        <div className="max-w-2xl text-left">
          ...
          <div className="mt-6 flex gap-6 ">
            ...
            />
            <SocialLink
              href="https://github.com/keithmancuso"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://threads.net/keithmancuso"
              aria-label="Follow on Threads"
              icon={ThreadsIcon}
            />
            <SocialLink
              href="https://instagram.com/keithmancuso"
